...
public class ModFoodComponents {
    ...
    static {
        ...
        COOKED_SWIMMER_CRAB = (new FoodComponent.Builder()).hunger(6).saturationModifier(0.6F).statusEffect(new StatusEffectInstance(ModEffects.XIAN,300,0),0.3F).meat().build();
        COOKED_HAIRY_CRAB = (new FoodComponent.Builder()).hunger(6).saturationModifier(0.6F).statusEffect(new StatusEffectInstance(ModEffects.XIAN,300,0),0.6F).meat().build();
        ...
        CLAM_CHOWDER = (new FoodComponent.Builder()).hunger(6).saturationModifier(1.0F).statusEffect(new StatusEffectInstance(ModEffects.XIAN,7200,0),1.0F).build();
    }
