...
public class ModEntitySpawn {
    ...
    public static void init(){
        BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.COLD_OCEAN,BiomeKeys.OCEAN,BiomeKeys.WARM_OCEAN,BiomeKeys.FROZEN_OCEAN), SpawnGroup.WATER_AMBIENT,ModEntities.PRAWN,10,3,5);
        BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.COLD_OCEAN,BiomeKeys.DEEP_COLD_OCEAN,BiomeKeys.OCEAN), SpawnGroup.WATER_AMBIENT,ModEntities.BROWN_CRAB,7,2,4);
        ...
        BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.WARM_OCEAN,BiomeKeys.LUKEWARM_OCEAN),SpawnGroup.WATER_AMBIENT,ModEntities.LOBSTER,7,2,5);
        ...
        BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.COLD_OCEAN,BiomeKeys.DEEP_COLD_OCEAN),SpawnGroup.WATER_AMBIENT,ModEntities.KING_CRAB,5,2,3);
